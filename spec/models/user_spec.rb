...
RSpec.describe User, type: :model do
  ...
  describe 'Class Methods' do
    it '.top_merchants(quantity)' do
      user = create(:user)
      address = create(:user_address, user: user, default: true)
      ...
      order = create(:completed_order, user: user, user_address: address)
  ...
  describe 'Instance Methods' do
    it '.merchant_items' do
      ...
      order_2 = create(:completed_order, user: user, user_address: address)
    ...
    it '.total_items_sold' do
      ...
      order_1 = create(:completed_order, status: :completed, user: user, user_address: address)
    ...
    it '.top_3_shipping_states' do
      ...
      order = create(:completed_order, user: user_2, user_address: address_2)
      create(:fulfilled_order_item, order: order, item: item_1)
      order = create(:completed_order, user: user_2, user_address: address_2)
      create(:fulfilled_order_item, order: order, item: item_1)
      order = create(:completed_order, user: user_2, user_address: address_2)
      create(:fulfilled_order_item, order: order, item: item_1)
      # Sorry Florida
      order = create(:completed_order, user: user_3, user_address: address_3)
      create(:fulfilled_order_item, order: order, item: item_1)
      order = create(:completed_order, user: user_4, user_address: address_4)
      # NY is 3rd place
      create(:fulfilled_order_item, order: order, item: item_1)
      order = create(:completed_order, user: user_4, user_address: address_4)
      create(:fulfilled_order_item, order: order, item: item_1)
    ...
    it '.biggest_order' do
      ...
      # user 2 is best to start
      order_2 = create(:completed_order, user: user_2, user_address: address_2)
    ...
    it '.top_buyers(3)' do
      ...
      order_3 = create(:completed_order, user: user_3, user_address: address_3)
